...
> **Note:** This documentation was generated with AI assistance to provide comprehensive coverage of the ScarletCore framework. However, **ScarletCore itself was not generated by AI** — the AI was only used to document the existing functionality, not to create the framework. As such, there may be inaccuracies or incomplete information in this documentation. If you find any errors, please [report them on GitHub](https://github.com/markvaaz/ScarletCore-Wiki/issues).
